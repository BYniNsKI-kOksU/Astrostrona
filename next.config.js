        ...
        headers: [
          ...
          // Content Security Policy — ochrona przed XSS
          {
            ...
            value: [
              ...
              "img-src 'self' data: blob: https://*.tile.openstreetmap.org https://*.basemaps.cartocdn.com https://apod.nasa.gov https://*.nasa.gov",
              "connect-src 'self' https://*.basemaps.cartocdn.com https://*.tile.openstreetmap.org https://api.open-meteo.com https://geocoding-api.open-meteo.com https://api.nasa.gov",
